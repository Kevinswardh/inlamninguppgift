...
const ContactForm = ({ formTitle, children }) => {
  ...
  const validationSchema = Yup.object().shape({
    fullName: Yup.string()
      ...
      .matches(
        /^[\p{L}\s-]+$/u, //Accepterar unicode, och alla "Diakritiska tecken" sedan whitespace och bindestreck.
    ...
    email: Yup.string()
      ...
      .matches(
        /^[A-Za-z0-9._%+-åäöÅÄÖ]{1,}@[A-Öa-ö0-9.-]{1,}\.[A-Öa-ö]{2,}$/,
        "Invalid email format: username@example.com"
      ), // Specifik regular expression för e-postformat antigen A-Ö eller åäö då alla chars inuti brackets gäller minst 1 tecken för snabel a ett efter en punk och minst 2.
