import ClickedButton from "../../assets/Pictures/qa-clicked-btn.svg";
const QaSection = () => {
  return (
    <div className="background-widescreen-fixer-qa-to-footer">
      <section className="section-max-width qa-padding">
        <grid className="qa-grid">
          ...
          {/* <!--Q & A Item 1--> */}
          <div className="qa-header-box">
            <h3>Is any of my personal information stored in the App?</h3>
            <div className="qa-btn-box-clicked">
              <img width="10px" height="6.18px" src={ClickedButton} />
            </div>
